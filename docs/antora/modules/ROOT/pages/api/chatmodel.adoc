...
* xref:api/chat/anthropic-chat.adoc[Anthropic Chat Completion] (streaming, multi-modality & function-calling support)
...
Azure OpenAI, Amazon Bedrock, Mistral AI, DeepSeek, Groq, MiniMax, Moonshot AI, NVIDIA, Perplexity AI, and QianFan.
====
