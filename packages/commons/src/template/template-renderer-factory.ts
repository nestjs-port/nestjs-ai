...
const DEFAULT_TEMPLATE_RENDERER = new DelegatingTemplateRenderer();

export abstract class TemplateRendererFactory {
  static bind(renderer: TemplateRenderer): void {
  ...
  static getTemplateRenderer(): TemplateRenderer {
