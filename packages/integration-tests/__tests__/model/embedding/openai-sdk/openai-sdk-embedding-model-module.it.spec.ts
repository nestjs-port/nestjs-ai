...
): Promise<OpenAiSdkEmbeddingModel> {
  const moduleRef = await Test.createTestingModule({
    imports: [OpenAiSdkEmbeddingModelModule.forFeature(properties)],
  }).compile();

  return moduleRef.get<OpenAiSdkEmbeddingModel>(EMBEDDING_MODEL_TOKEN);
}

describe.skipIf(!OPENAI_API_KEY)("OpenAiSdkEmbeddingModelModuleIT", () => {
  it("embedding", async () => {
