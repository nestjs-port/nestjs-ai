 ...
 * in an asynchronous way. It supports methods with a single `Resource[]` parameter.
 */
export class McpResourceListChangedMethodCallback extends AbstractMcpResourceListChangedMethodCallback {
  ...
  async apply(updatedResources: Resource[]): Promise<void> {
    ...
    try {
      ...
      const args = this.buildArgs(null, updatedResources);
   ...
   */
  static builder(): McpResourceListChangedMethodCallbackBuilder {
    return new McpResourceListChangedMethodCallbackBuilder();
  }
}

/**
 * Builder for creating McpResourceListChangedMethodCallback instances.
 *
 * This builder provides a fluent API for constructing
 * McpResourceListChangedMethodCallback instances with the required parameters.
 */
export class McpResourceListChangedMethodCallbackBuilder {
  ...
  /**
   * Set the resource list changed annotation metadata.
   * @param _resourceListChanged The resource list changed metadata
   * @returns This builder
   */
  resourceListChanged(
    _resourceListChanged: McpResourceListChangedMetadata,
  ): this {
  ...
  /**
   * Build the callback.
   * @returns A new McpResourceListChangedMethodCallback instance
   */
  build(): McpResourceListChangedMethodCallback {
    ...
    return new McpResourceListChangedMethodCallback(
      this._bean,
      this._propertyKey,
    );
  }
