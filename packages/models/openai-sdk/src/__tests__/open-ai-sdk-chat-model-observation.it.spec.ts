...
describe.skipIf(!OPENAI_API_KEY)("OpenAiSdkChatModelObservationIT", () => {
  let observationRegistry: TestObservationRegistry;
  let chatModel: OpenAiSdkChatModel;

  beforeEach(() => {
    observationRegistry = TestObservationRegistry.create();
    chatModel = new OpenAiSdkChatModel({
      options: new OpenAiSdkChatOptions({
